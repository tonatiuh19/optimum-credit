...
import AdminClientDetail from "@/components/admin/ClientDetail";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/portal/onboarding/:token" element={<Onboarding />} />
        ...
        <Route
          path="/portal/reports"
          element={<RequireClient>{wrap(ClientLayout, Reports)}</RequireClient>}
        />
        <Route
          path="/portal/support"
          element={<RequireClient>{wrap(ClientLayout, Support)}</RequireClient>}
        />
        <Route
          path="/portal/videos"
          element={<RequireClient>{wrap(ClientLayout, Videos)}</RequireClient>}
        />
        <Route
          path="/portal/profile"
          element={<RequireClient>{wrap(ClientLayout, Profile)}</RequireClient>}
        />
        <Route
          path="/portal/payments"
          element={
            <RequireClient>{wrap(ClientLayout, ClientPayments)}</RequireClient>
          }
        />
        ...
        <Route
          path="/admin"
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminDashboard)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/clients"
        ...
        <Route
          ...
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminClientDetail)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/pipeline"
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminPipeline)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/documents"
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminDocuments)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/conversations"
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminConversations)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/tickets"
        ...
        <Route
          ...
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminTemplates)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/videos"
        ...
        <Route
          ...
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminReminderFlows)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/payments"
        ...
        <Route
          path="/admin/calendar"
          element={
            <RequireAdmin>{wrap(AdminLayout, AdminCalendar)}</RequireAdmin>
          }
        />
        <Route
          path="/admin/tasks"
          element={<RequireAdmin>{wrap(AdminLayout, AdminTasks)}</RequireAdmin>}
        />

        {/* Portal - Tasks (redirected to Documents) */}
        <Route
          path="/portal/tasks"
          element={<Navigate to="/portal/documents" replace />}
        />
